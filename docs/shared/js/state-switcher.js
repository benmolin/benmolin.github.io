...
var states = [
    ...
    ['District of Columbia', 'DC', 'DC resident'],
    ...
    ['Hawaii', 'HI_HH1', 'Hawaii resident'],
    ['Hawaii', 'HI_HH2', 'Hawaii resident'],
    ['Hawaii', 'HI_HH3', 'Hawaii resident'],
    ['Hawaii', 'HI_HH_4_5', 'Hawaii resident'],
    ['Hawaii', 'HI_HH_6', 'Hawaii resident'],
    ['Hawaii', 'HI_HH_7_X', 'Hawaii resident'],
    ['Idaho', 'ID', 'Idahoan'],
